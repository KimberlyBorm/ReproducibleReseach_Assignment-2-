---
title: "Storm Types Effects on Population Health and Econmoic Loss: what weather events are the most harmful? "
...
To answer these questions the original data was modified into three groups.

1. Total fatalities by weather event.
2. Total fatalities and injuries by weather event.
3. Total cost of property and crop damage per weather event. 
...
We will first address population health in two parts. 
...
To further demonstrate the amount of risk these events pose, the percentage of overall health impact is calculated. 
...
This confirms that tornadoes are the largest risk to population health of all storm related events.
...
It is worth poitning out that flood damage appears to be more than double the damage cause by any other weather event. 
...
This confirms that floods pose the largest economic risk, and are more than double the economic damage of any other weather event.

Also, hurricane/typhoons and tornadoes combined pose almost as large an economic risk as floods. 
